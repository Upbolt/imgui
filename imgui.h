...
namespace ImGui
{
    ...
    IMGUI_API void          LabelTextClipped(const char* label)                             IM_FMTARGS(1); // display text+label aligned the same way as value+label widgets
    IMGUI_API void          LabelTextBackground(const char* label)                          IM_FMTLIST(1);
